...
function parseRamp(j) {
	let M = {};
	for (let [N, P] of Object.entries(j)) {
		let j = N.replace(/[a-zA-Z]/g, ""), F = oklch(parse(P));
		F && (M[j] = F);
	}
	return M;
}
const radixRamps = new Map([
	["gray", parseRamp(gray)],
...
var radix_default = radixRamps;
export { radix_default as default, radixRamps };
